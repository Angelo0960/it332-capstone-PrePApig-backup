...
// Import your Firebase token generator
import { generateToken } from '../services/firebase.js';   // adjust path if needed
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      try {
        ...
        if (fcmToken) {
          await fetch('http://localhost:5000/notifications/register-token', {
            method: 'POST',
            headers: {
